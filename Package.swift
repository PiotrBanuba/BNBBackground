...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-63-g5825a46ccf/BNBBackground.zip",
            checksum: "1a31ab324cedfb74f071aca079e5a5c38b7dc4e31ae9931066afb8f12ca13eea"
        ),
        .target(
