...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-64-g951557ebd1/BNBBackground.zip",
            checksum: "d78319c9194baec5d7bf07ce0f65a720247600c5f6627ef771124679869459b7"
        ),
        .target(
