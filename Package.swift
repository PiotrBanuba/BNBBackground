...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-61-g2b7f7b2a6c/BNBBackground.zip",
            checksum: "02b895191c55db803e9862ee40a61de89022f5983c981face0dc5577dbc57dfc"
        ),
        .target(
