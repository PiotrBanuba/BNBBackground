...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-63-g6aa1953f1a/BNBBackground.zip",
            checksum: "a4276acee4d5c0676af6544649c040d0f1984690840a324e251afe734e32be69"
        ),
        .target(
