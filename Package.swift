...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBBackground",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.1-83-gf89cbbd807/BNBBackground.zip",
            checksum: "d9216de7ad3745180bd38528cb27d8ee254d6a374e87a877a49fb759e1664206"
        ),
        .target(
